...
const AdminModal = () => {
  ...
  return (
    <>
      {/* Admin Icon */}
      <button onClick={modalHandler} className="btn btn-ghost btn-circle cursor-pointer">
        ...
        <div className="modal modal-open">
          <div className="modal-box bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 text-white relative">
            ...
            <form className="space-y-4">
              ...
              <button type="submit" className="btn w-full bg-blue-800 hover:bg-blue-900 text-white">
                Giriş Yap
              </button>
            </form>
          </div>
