        ...
        <div className="container mx-auto px-4 flex items-center justify-between py-4">
          ...
          <ul className="hidden md:flex space-x-6 relative">
            ...
            <li className="relative">
              ...
              />
              <Dropdown isOpen={openDropdown === "library" && location.pathname === "/library"} items={libraryCategories} baseLink="/library" />
            </li>
            <li className="relative">
              <NavigationItem
                  to="/mentoring"
              ...
              />
              <Dropdown isOpen={openDropdown === "mentoring" && location.pathname === "/mentoring"} items={mentoringGrades} baseLink="/mentoring" />
            </li>
